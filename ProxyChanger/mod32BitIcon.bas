...
'============================================================================================================
'
' Description : When setting an icon in the form properties, VB will not accept 48x48 and 32-bit colour
'               depth icons.
'
'               This module does allow you to use 48x48 and 32-bit colour depth icons as application icon.
'
'============================================================================================================
'
' Usage       : For a full explanation visit the site below:
