...
'======================================================================================================
'
' Description : This module is used to center the CommonDialog window.
'               It's not necessary, but it looks nicer when it's shown in the center of the screen.
'
'======================================================================================================
'
' Usage       : Put 'SetHook' in the Form_Load event.
