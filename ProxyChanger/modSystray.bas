...
'7000=7 seconds
Public Const APP_TIMER_MILLISECONDS As Long = 3000
...
Public Sub ShellTrayIconModify(hWnd As Long, _
                            hIcon As StdPicture, _
                            sToolTip As String)
      ...
      Case WM_TIMER
         ...
         If idEvent = APP_TIMER_EVENT_ID Then
            If tmrRunning = True Then
               ...
               Call TimerStop(hWnd)
               Call ShellTrayBalloonTipClose(frmMain.hWnd)
                 ...
                 'form is hidden, it (correctly) has no effect.
                  Call SetForegroundWindow(frmMain.hWnd)
                    ...
                    If frmMain.WindowState = 0 Then
                        frmMain.mnuSetProxy.Checked = True
                    Else
                        frmMain.mnuSetProxy.Checked = False
                    End If
                  
                    frmMain.PopupMenu frmMain.mnuSystray
               
                  'Bring back to desktop
                  Case WM_LBUTTONDOWN
